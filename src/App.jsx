...
function Reports({ws,reload,notify}) {
  ...
  const inventoryRows=useMemo(()=>ws.ingredients.map(i=>{
    ...
    return {
      ...i,stock,threshold,cost,
      status:stock<=0?"Out of stock":stock<=threshold?"Low stock":"Healthy",
      value:stock*cost,
      lastMovement:last?.created_at||null,
      lastMovementType:last?.movement_type||"—"
    };
